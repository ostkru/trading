...
func (s *Service) CreateOffer(req CreateOfferRequest, userID int64) (*Offer, error) {
	...
	var offer Offer
	err := s.db.QueryRow(query, userID, req.ProductID, req.OfferType, req.PricePerUnit, req.AvailableLots, req.TaxNDS, req.UnitsPerLot, req.WarehouseID, req.IsPublic, req.MaxShippingDays).Scan(
