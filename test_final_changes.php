...
echo "✅ 2. Параметр is_public НЕ обязательный в CreateOfferRequest (default=true)\n";
...
echo "\n🧪 ТЕСТ 2: Проверка необязательного параметра is_public с default=true\n";
echo "--------------------------------------------------------\n";
...
echo "✅ is_public стал необязательным с default=true\n";
echo "✅ Новая логика лимитов работает правильно\n";
echo "\n📝 ЗАКЛЮЧЕНИЕ:\n";
echo "Все замечания пользователя исправлены:\n";
echo "1. ✅ is_public стал необязательным параметром с default=true\n";
